...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
		<select class="form-control" onchange="location = this.value;">
            ...
            <option value="{{ url('') }}/Penilaian/kategori/1">Pre-Starter</option>
            <option value="{{ url('') }}/Penilaian/kategori/2">Starter</option>
            <option value="{{ url('') }}/Penilaian/kategori/3">Finisher</option>
		</select>
	</div>
</div>
