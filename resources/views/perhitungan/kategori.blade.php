...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
		<select class="form-control" onchange="location = this.value;">
            ...
            <option value="{{ url('') }}/Perhitungan/kategori/1" <?php if($kategori == 1){echo "selected";} ?>>Pre-Starter</option>
            <option value="{{ url('') }}/Perhitungan/kategori/2" <?php if($kategori == 2){echo "selected";} ?>>Starter</option>
            <option value="{{ url('') }}/Perhitungan/kategori/3" <?php if($kategori == 3){echo "selected";} ?>>Finisher</option>
		</select>
	</div>
</div>
...
if(count($alternatifs) <= 0){
    echo "<div class='alert alert-danger text-center'>Data alternatif masih kosong</div>";
}else{

\App\Models\PerhitunganModel::hapus_hasil($kategori);
